...
bool fetchForecast() {
  ...
  const char* url = "https://api.open-meteo.com/v1/forecast?latitude=42.2&longitude=24.3333&daily=weather_code,temperature_2m_max,temperature_2m_min,precipitation_sum,wind_speed_10m_max&models=meteofrance_arpege_europe,meteofrance_arome_france_hd&timezone=auto";
